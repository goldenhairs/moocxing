...
moocxing框架是[上海慕客信信息科技有限公司](http://www.batago.cn/)为了方便**语音助手**与**物联网**教学而开发的框架。主要用于学生上课和学生竞赛使用。基于此框架可以实现快速搭建一个语音助手、能方便调用物联网通信协议、帮助我们快速搭建程序原型。此框架包含了七个独立功能模块，技能插件机制，其中技能插件可由用户二次开发。
